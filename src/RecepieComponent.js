function RecepieComponent({label, image, calories, ingredients, dish}) {
    ...
    <div className="box">
       ...
       <ul className="list">
          ...
          <li key={index}>
             <img src="https://img.freepik.com/free-vector/green-eco-loop-leaf-check-mark_78370-658.jpg?w=740&t=st=1677316023~exp=1677316623~hmac=65cfc0081ce55c62e7cfbe102ec5f6ba99013901bdb2bd546869af591980009d" width="50px" alt="tick"/>{element}
          </li>
          ))}
       </ul>
